...
class date extends OOTemplate_FilterAdapter 
{
	public function resolve (OOTemplate_Context $context)
	{
		if (!is_numeric ($this->_resolved))
			$this->_resolved = strtotime ($this->_resolved);
		return strftime (implode (' ', $this->_args), $this->_resolved);
	}
}
